...
# 获得训练用的wav文件路径列表 
aa = r"E:\ceydafile\我的比赛\互联网加\测试demo代码"
# bb=['fold1/','fold2/','fold3/']
bb = ['test_audio/']
wav_files = get_wav_files(aa, bb)
# 获取文件mfcc特征和对应标签
tr_features, tr_labels = extract_features(wav_files)

np.save('tr_features_demo.npy', tr_features)
np.save('tr_labels_demo.npy', tr_labels)
